 ...
 *
 * @method  bool addFile(StringHelper $filename, StringHelper $localname = null)
 * @method  bool addFromString(StringHelper $localname, StringHelper $contents)
 * @method  StringHelper getNameIndex(int $index)
 * @method  int locateName(StringHelper $name)
 *
 * @since   0.10.0
 */
class ZipArchive
